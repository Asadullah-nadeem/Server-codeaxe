        ...
        <div className="flex flex-wrap gap-2 mb-12 border-b border-border pb-6">
          {allCategories.map((cat) => (
            <Link
              ...
              className={`px-4 py-2 font-mono-label text-xs uppercase tracking-widest transition-colors duration-200 border ${slug === cat.slug
          ...
          <div className="flex items-center justify-center gap-2 mt-16">
            ...
            {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
              <button
                ...
                className={`w-10 h-10 flex items-center justify-center font-mono-label text-xs transition-colors duration-200 border ${page === currentPage
